...
<style>
    /* ---------------------------
       CUSTOM PAGE CSS (same as category)
    -----------------------------*/
    .custom-card {
        background: #ffffff;
        border-radius: 10px;
    ...
    @media(max-width: 768px) {
        .custom-card-header { flex-direction: column; align-items: flex-start; gap: 10px; }
    }
</style>
        ...
        <div class="custom-card">
            ...
            <div class="card-body p-3">
                <div class="table-responsive">
                    <table id="productTable" class="display" style="min-width: 100%; width: 100%;">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
