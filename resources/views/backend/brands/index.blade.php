...
@section('content')
<style>
    /* Reuse category page styling */
    .custom-card { background:#fff; border-radius:10px; padding:0; box-shadow:0px 4px 12px rgba(0,0,0,0.08); overflow:hidden; }
        ...
        <div class="custom-card">
            ...
            <div class="card-body p-3">
                <div class="table-responsive">
                    <table id="brandTable" class="display" style="min-width: 100%; width: 100%;">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
